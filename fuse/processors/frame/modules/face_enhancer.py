...
from fuse.face_analyser import get_many_faces, clear_face_analyser
from fuse.typing import Face, Frame, Matrix, Update_Process, ProcessMode, ModelValue, OptionsWithModel
...
NAME = 'FUSE.FRAME_PROCESSOR.FACE_ENHANCER'
MODELS : Dict[str, ModelValue] =\
{
	'codeformer':
	{
		'url': 'https://github.com/fuse/fuse-assets/releases/download/models/codeformer.onnx',
		'path': resolve_relative_path('../.assets/models/codeformer.onnx')
	},
	'gfpgan_1.2':
	{
		'url': 'https://github.com/fuse/fuse-assets/releases/download/models/GFPGANv1.2.onnx',
		'path': resolve_relative_path('../.assets/models/GFPGANv1.2.onnx')
	},
	'gfpgan_1.3':
	{
		'url': 'https://github.com/fuse/fuse-assets/releases/download/models/GFPGANv1.3.onnx',
	...
	'gpen_bfr_512':
	{
		'url': 'https://github.com/fuse/fuse-assets/releases/download/models/GPEN-BFR-512.onnx',
...
def get_frame_processor() -> Any:
	...
	with THREAD_LOCK:
		if FRAME_PROCESSOR is None:
			...
			FRAME_PROCESSOR = onnxruntime.InferenceSession(model_path, providers = fuse.globals.execution_providers)
...
def process_video(source_path : str, temp_frame_paths : List[str]) -> None:
	fuse.processors.frame.core.multi_process_frames(None, temp_frame_paths, process_frames)

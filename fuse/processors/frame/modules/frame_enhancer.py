...
from fuse.face_analyser import clear_face_analyser
from fuse.typing import Frame, Face, Update_Process, ProcessMode, ModelValue, OptionsWithModel
from fuse.utilities import conditional_download, resolve_relative_path, is_file, is_download_done, get_device
...
NAME = 'FUSE.FRAME_PROCESSOR.FRAME_ENHANCER'
MODELS: Dict[str, ModelValue] =\
{
	'realesrgan_x2plus':
	{
		'url': 'https://github.com/fuse/fuse-assets/releases/download/models/RealESRGAN_x2plus.pth',
		'path': resolve_relative_path('../.assets/models/RealESRGAN_x2plus.pth'),
		'scale': 2
	},
	'realesrgan_x4plus':
	{
		'url': 'https://github.com/fuse/fuse-assets/releases/download/models/RealESRGAN_x4plus.pth',
		'path': resolve_relative_path('../.assets/models/RealESRGAN_x4plus.pth'),
		'scale': 4
	},
	'realesrnet_x4plus':
	{
		'url': 'https://github.com/fuse/fuse-assets/releases/download/models/RealESRNet_x4plus.pth',
	...
	with THREAD_LOCK:
		if FRAME_PROCESSOR is None:
			...
			FRAME_PROCESSOR = RealESRGANer(
				...
				device = get_device(fuse.globals.execution_providers),
				scale = model_scale
			)

...
from fuse.processors.frame import globals as frame_processors_globals, choices as frame_processors_choices
...
def render() -> None:
	...
	FACE_SWAPPER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'face_swapper' in fuse.globals.frame_processors
	)
	FACE_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'face_enhancer' in fuse.globals.frame_processors
	)
	...
	FRAME_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		...
		visible = 'frame_enhancer' in fuse.globals.frame_processors
	)

...
from fuse.predictor import predict_stream
...
from fuse.utilities import open_ffmpeg
from fuse.vision import normalize_frame_color, read_static_image
from fuse.uis.typing import StreamMode, WebcamMode
...
def start(mode: WebcamMode, resolution: str, fps: float) -> Generator[Frame, None, None]:
	fuse.globals.face_recognition = 'many'

...
from fuse.typing import TempFrameFormat
...
def render() -> None:
	...
	TEMP_FRAME_FORMAT_DROPDOWN = gradio.Dropdown(
		...
		value = fuse.globals.temp_frame_format,
	...
	TEMP_FRAME_QUALITY_SLIDER = gradio.Slider(
		...
		value = fuse.globals.temp_frame_quality,
		step = 1,
		minimum = 0,
		maximum = 100,
		visible = is_video(fuse.globals.target_path)
...
def update_temp_frame_format(temp_frame_format : TempFrameFormat) -> None:
	fuse.globals.temp_frame_format = temp_frame_format


def update_temp_frame_quality(temp_frame_quality : int) -> None:
	fuse.globals.temp_frame_quality = temp_frame_quality

...
from fuse.face_analyser import get_face_analyser
from fuse.face_cache import clear_faces_cache
from fuse.processors.frame.core import get_frame_processors_modules
from fuse.vision import count_video_frame_total
from fuse.core import limit_resources, conditional_process
from fuse.utilities import normalize_output_path, clear_temp
...
def start(benchmark_runs : List[str], benchmark_cycles : int) -> Generator[List[Any], None, None]:
	fuse.globals.source_path = '.assets/examples/source.jpg'
...
def benchmark(target_path : str, benchmark_cycles : int) -> List[Any]:
	...
	for i in range(benchmark_cycles):
		fuse.globals.target_path = target_path
		fuse.globals.output_path = normalize_output_path(fuse.globals.source_path, fuse.globals.target_path, tempfile.gettempdir())
